          ...
          {selectedLevel === "01" && (
            <div ref={contentRef} className={styles.levelContent}>
              ...
              <div className={styles.blStepBlock} data-step="bl-01">
                <div className={styles.contentStep}>
                  ...
                  <p className={styles.contentBody}>
                    ...
                    people. They are repetitive, slow, and hard to scale. The
                    gap looks different depending on where you are.
                  </p>
                </div>
                ...
                <div className={styles.contentGrid}>
                  <div className={styles.contentCard}>
                    ...
                    <ul className={styles.bulletList}>
                      ...
                      <li>
                        Repetitive workflows require human involvement every
                        time
                      </li>
                    </ul>
                  </div>
                  <div className={styles.contentCard}>
                    ...
                    <ul className={styles.bulletList}>
                      <li>
                        Thousands of customer queries handled by an
                        overstretched team
                      </li>
              ...
              <div style={{ marginTop: "2rem" }} data-step="bl-03">
                ...
                <h2 className={styles.contentTitle}>
                  Agent Kernel is the engine that powers it at scale to run
                  compliant AI agents
                </h2>
                ...
                <div className={styles.blHighlightCard}>
                  ...
                  <p className={styles.blHighlightBody}>
                    You don't need to understand how an operating system works
                    to use the Internet. It runs behind the scenes, powering
                    websites, servers, and cloud systems.
                  </p>
                  <p className={styles.blHighlightBody}>
                    Agent Kernel does the same thing for AI agents. It's a
                    powerful platform that runs your AI agents in the
                    background, handling all the complex infrastructure so that
                    you focus on building the features that matter to your
                    business.
                  </p>
                </div>
                ...
                <div className={styles.blValueGrid}>
                  <div className={styles.blValueCard}>
                    ...
                    <p className={styles.blValueBody}>
                      No one must build agent infrastructure from scratch. Go
                      from idea to enterprise-grade working scalable AI agents
                      in days.
                    </p>
                  </div>
                  <div className={styles.blValueCard}>
            ...
            <div ref={contentRef} className={styles.developerContent}>
              ...
              >
                ...
                <h2 className={styles.devTitle}>
                  Building blocks and and deployment infrastructure for your AI
                  Agent.
                </h2>
                  ...
                  <div className={styles.devBulletList}>
                    <div className={styles.devBulletItem}>
                      ...
                      <span className={styles.devBulletText}>
                        Install it on your laptop, sever, or cloud and run AI
                        agents hassle-free.
                      </span>
                    </div>
                    <div className={styles.devBulletItem}>
